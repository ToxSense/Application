...
import kotlinx.android.synthetic.main.aqilayout.*
import java.io.ByteArrayOutputStream


class AQI : AppCompatActivity() {
    ...
    private var tfLiteClassifier: TFLiteClassifier = TFLiteClassifier(this@AQI)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.aqilayout)
        title = "ToxSense"
        ...
        analyzerUseCase.analyzer =
            ImageAnalysis.Analyzer { image: ImageProxy, rotationDegrees: Int ->
                ...
                tfLiteClassifier
                    ...
                    .addOnSuccessListener { resultText -> predictedTextView?.text = "Prediction is ${resultText[0]}\nInference Time ${resultText[2]} ms"; predImg?.setImageBitmap(resultText[1] as Bitmap?) }
                    .addOnFailureListener { error -> predictedTextView?.text = error.toString() }
